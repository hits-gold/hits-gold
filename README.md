...
|CJ Logistics DT인프라 인턴십|2023.01.16 ~ 2023.02.17|인턴|Crawling, Tableau, ML|원자재가격 자동화 크롤링 엔진&대시보드 개발|
...
|2023~|골프 스윙 영상 이벤트 탐지 모델 개발|CV, Event Detection, Video Understanding||
...
|2022|안면 이미지 초해상화와 특징점 검출|CV, Super-resolution, Landmark detection|정리중|
